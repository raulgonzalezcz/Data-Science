...
g <- xml2::read_html(url) #OBTIENE LOS DATOS POR MEDIO DE UN CROWLER en XML
g

# These divs hold our data
state.winprobs <- g %>% rvest::html_nodes('.cards') #solo obtiene los divs que tienen la clase "cards"
...
electoral.votes #los votos por estado pero aun sin distinguir de cuales votos son de que estado
...
states #ABREVIACION DE LOS ESTADOS
...
#########################
winprobs ############################################## CORRER, aqui se ve la tabla con los datos ya obtenidos ESTO ES LO QUE NECESITAMOS OBTENER!
##############################
